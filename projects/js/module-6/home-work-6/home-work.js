...
class Hamburger {
  ...
  get calculatePrice() {
   ...
   const priceToppings = this._toppings.reduce((acc, topping) => Hamburger.TOPPINGS[topping].price + acc, 0);
   return sizePrice +  priceStuffing + priceToppings;
  }
  ...
  get calculateCalories() {
    const gamburgerCalories = Hamburger.SIZES[this._size].calories;
    ...
    return gamburgerCalories + stuffingCalories + toppingsCalories;
  }
}
